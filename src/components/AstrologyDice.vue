...
<div>
	...
	<p>歡迎把占卜問題及搖出骰子的結果，<br>寄給占卜師為您親自解答唷<br>快樂結緣，費用隨喜，開心就好 :D<br>E-mail: lisebee212@gmail.com</p>
	<div class="btn-group">
	...
	<div v-if="diceArr.length>0">
		<h3>投出的結果是..</h3>
		<div class="box-group">
			<div class="box" v-for="(dice,index) in diceArr" :key="index"><span>{{ dice.name }}</span></div>
		</div>
	</div>
</div>
</template>
...
export default ({
	...
	methods: {
		...
		shake() {
			...
			this.constellation = this.constellationArr[this.getRandom(this.constellationArr.length)];
